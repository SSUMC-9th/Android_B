...
class AlbumBanner1RVAdapter(private var albumList: ArrayList<AlbumBanner1>): RecyclerView.Adapter<AlbumBanner1RVAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlbumBanner1RVAdapter.ViewHolder {
        val binding: ItemAlbumBanner1Binding = ItemAlbumBanner1Binding.inflate(LayoutInflater.from(parent.context), parent, false)

        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AlbumBanner1RVAdapter.ViewHolder, position: Int) {
